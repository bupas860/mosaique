...
for (const expected of ['route.kind !== "home" && isEleaContext()', '!eleaPresentation && <nav', '<span className="public-brand">{PUBLIC_BRAND}</span>', 'public-footer--elea']) if (!frame.includes(expected)) throw new Error(`Chrome Éléa incomplet : ${expected}`);
